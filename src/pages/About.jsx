...
const companyValues = [
  {
    ...
    desc: 'We adhere strictly to clean code architecture, modular component patterns, and solid performance benchmarks.'
  },
  {
    icon: Cpu,
    title: 'AI Native Development',
    desc: 'We leverage AI in our internal engineering pipelines and integrate intelligent tools into client products.'
  },
  {
    icon: Shield,
    title: 'Security & Privacy',
    desc: 'Data privacy, secure authentication, sanitized inputs, and protected database connections are non-negotiable.'
  },
  {
    icon: Target,
    title: 'Practical Business Impact',
    desc: 'We design digital products that drive measurable efficiency gains, online presence, and business growth.'
  }
];
    ...
    <div className="space-y-16 sm:space-y-24 lg:space-y-32 pt-28 sm:pt-36 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto font-inter bg-[#F8F9FC] text-[#0D0D14]">
      ...
      <section className="text-center space-y-6 max-w-3xl mx-auto">
        ...
        <h1 className="font-sora text-4xl sm:text-6xl font-extrabold text-[#0D0D14] tracking-tight">
          Building Modern <span className="brand-text-gradient">Digital Solutions</span>
        </h1>
        <p className="text-slate-600 text-base sm:text-lg leading-relaxed">
          NimraDev Labs is a growing software engineering company based in Pakistan. We design, engineer, and deploy high-quality web applications, e-commerce stores, custom software, and AI solutions for businesses and organizations.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#6C3FFC]/15 space-y-4 shadow-purple-glow">
          ...
          <p className="text-slate-600 text-sm leading-relaxed font-inter">
            To build modern digital solutions that empower businesses to scale with confidence, setting high standards in performance, AI integration, and design.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#6C3FFC]/15 space-y-4 shadow-purple-glow">
          ...
          <p className="text-slate-600 text-sm leading-relaxed font-inter">
            To solve technical challenges for businesses by shipping clean, secure, and production-ready Web, E-Commerce, AI, and Custom Software applications.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            <h3 className="font-sora font-bold text-2xl sm:text-3xl text-[#0D0D14]">
              Software Engineering Team in Pakistan
            </h3>
            <p className="text-slate-600 text-sm leading-relaxed font-inter">
              Headquartered in Pakistan, providing reliable engineering services to local businesses, startups, and growing enterprises.
            </p>
            <div className="space-y-2 pt-2 text-xs text-slate-700 font-inter">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="text-[#6C3FFC] w-4 h-4" />
                <span>Responsive customer support and direct developer communication.</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="text-[#6C3FFC] w-4 h-4" />
                <span>Transparent milestone pricing and regular progress updates.</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-[#F8F9FC] border border-slate-200 space-y-4 text-center">
            ...
            <p className="text-xs text-slate-500 font-inter">Talk with our development team about your project requirements.</p>
            <Link
              to="/contact"
